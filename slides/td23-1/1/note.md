...
<!-- 
paginate: true 
header: Aula 1 - O que é Teoria da Decisão?
footer: lucas.gomes@fgv.br | 14/02/2023
-->
...
## <!--fit-->Exemplo de argumento consequencialista no Direito

#### <!--fit-->Aplicação do teto dos benefícios previdenciários para a gestante
...
* Consequencialismo não é o mesmo que:
  * Utilitarismo…
